...
- [ ] Patron interface (iPad): browse cocktails by category, view recipe/flavor/photo detail (styled closely on the referenced dark-neon cocktail-menu aesthetic), and either just browse or submit an order
