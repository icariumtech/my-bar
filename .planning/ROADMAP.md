...
- [x] 02-07-PLAN.md — Gap closure: fix UnitDropdown/GlasswareSelector value/onChange binding + apiFetch real error surfacing (G-02-6)
...
- [x] 02-03-PLAN.md — Glassware CRUD backend with recipe-usage delete guard (D-17, D-22)

**Wave 3** *(blocked on Wave 2 completion)*

- [x] 02-04-PLAN.md — Glassware management UI (D-17, D-22)
- [x] 02-05-PLAN.md — Recipe list + delete + form sub-components (ingredients/method/unit/glassware selector)
...
- [x] 02.1-07-PLAN.md — Recipe detail full-screen conversion + per-line tri-state indicators (MATCH-05, BARBACK-02)
...
- [ ] 03-01-PLAN.md — Tracer: tag/description schema + shared contracts + tags/recipes API + DB push + Patron app scaffold with real recipe grid (PATR-03)
...
| 3. Patron Browse Experience | 0/5 | Not started | - |
