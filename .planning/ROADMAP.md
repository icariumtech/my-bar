...
- [ ] **Phase 1: Barback Inventory Foundation** - Owner can fully manage real bottle/ingredient inventory from their phone
...
|-------|----------------|--------|-----------|
| 1. Barback Inventory Foundation | 6/6 | In Progress|  |
